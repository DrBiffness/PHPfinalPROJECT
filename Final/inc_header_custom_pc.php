...
<button class="tablink" id="defaultOpen" onClick="openCity('Paris', this, 'green')" >Custom PC Builder</button>
...
function openSupport() {
  var myWindow = window.open("/my-site/html_ideas_2/support.php", "_parent", "");
}
</script>
